package com.screen.videos.customview.pickernumber;
...
public class NumberPicker2 extends LinearLayout {
    ...
    public interface OnValueChangeListener {
         ...
         */
        void onValueChange(NumberPicker2 picker, int oldVal, int newVal);
    }
    ...
    public interface OnScrollListener {
         ...
         *            {@link #SCROLL_STATE_IDLE}.
         */
        public void onScrollStateChange(NumberPicker2 view, int scrollState);
    }
    ...
    public NumberPicker2(Context context, AttributeSet attrs, int defStyle) {
        ...
        mInputText.setPadding(dpToPx(50),0,0,0);
    ...
    class AccessibilityNodeProviderImpl extends AccessibilityNodeProvider {
                ...
                case View.NO_ID: {
                    switch (action) {
                        ...
                        case AccessibilityNodeInfo.ACTION_SCROLL_FORWARD: {
                            if (NumberPicker2.this.isEnabled() && (getWrapSelectorWheel() || getValue() < getMaxValue())) {
                                changeValueByOne(true);
                                return true;
                            }
                        } return false;
                        case AccessibilityNodeInfo.ACTION_SCROLL_BACKWARD: {
                            if (NumberPicker2.this.isEnabled() && (getWrapSelectorWheel() || getValue() > getMinValue())) {
                                changeValueByOne(false);
                                return true;
                            }
                        } return false;
                ...
                case VIRTUAL_VIEW_ID_INPUT: {
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_FOCUS: {
                            if (NumberPicker2.this.isEnabled() && !mInputText.isFocused()) {
                ...
                case VIRTUAL_VIEW_ID_INCREMENT: {
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_CLICK: {
                            if (NumberPicker2.this.isEnabled()) {
                                NumberPicker2.this.changeValueByOne(true);
                    ...
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_CLICK: {
                            if (NumberPicker2.this.isEnabled()) {
                                ...
                                NumberPicker2.this.changeValueByOne(increment);
                                sendAccessibilityEventForVirtualView(virtualViewId, AccessibilityEvent.TYPE_VIEW_CLICKED);
                                return true;
                            }
                        } return false;
        ...
        private void sendAccessibilityEventForVirtualText(int eventType) {
            if (((AccessibilityManager) getContext().getSystemService(Context.ACCESSIBILITY_SERVICE)).isEnabled()) {
                ...
                event.setSource(NumberPicker2.this, VIRTUAL_VIEW_ID_INPUT);
                requestSendAccessibilityEvent(NumberPicker2.this, event);
            }
        }
        ...
        private void sendAccessibilityEventForVirtualButton(int virtualViewId, int eventType, String text) {
            if (((AccessibilityManager) getContext().getSystemService(Context.ACCESSIBILITY_SERVICE)).isEnabled()) {
                ...
                event.setEnabled(NumberPicker2.this.isEnabled());
                event.setSource(NumberPicker2.this, virtualViewId);
                requestSendAccessibilityEvent(NumberPicker2.this, event);
            }
        }
        ...
        private AccessibilityNodeInfo createAccessibiltyNodeInfoForInputText() {
            ...
            info.setSource(NumberPicker2.this, VIRTUAL_VIEW_ID_INPUT);
        ...
        private AccessibilityNodeInfo createAccessibilityNodeInfoForVirtualButton(int virtualViewId,
            ...
            info.setSource(NumberPicker2.this, virtualViewId);
            info.setParent(NumberPicker2.this);
            info.setText(text);
            info.setClickable(true);
            info.setLongClickable(true);
            info.setEnabled(NumberPicker2.this.isEnabled());
        ...
        private AccessibilityNodeInfo createAccessibilityNodeInfoForNumberPicker(int left, int top, int right, int bottom) {
            ...
            info.setPackageName(getContext().getPackageName());
            info.setSource(NumberPicker2.this);

            if (hasVirtualDecrementButton()) {
                info.addChild(NumberPicker2.this, VIRTUAL_VIEW_ID_DECREMENT);
            }
            info.addChild(NumberPicker2.this, VIRTUAL_VIEW_ID_INPUT);
            if (hasVirtualIncrementButton()) {
                info.addChild(NumberPicker2.this, VIRTUAL_VIEW_ID_INCREMENT);
            }
