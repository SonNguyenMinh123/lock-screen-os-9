...
public class TrashView extends FrameLayout implements ViewTreeObserver.OnPreDrawListener {
    ...
    public static final int ANIMATION_FORCE_CLOSE = 3;
     ...
     */
    public void calcActionTrashIconPadding(float width, float height, float shape) {
     ...
     */
    public void setTrashViewListener(TrashViewListener listener) {
