...
public class SharedPreferencesUtil {
    ...
    public static final String TAG_SELECT_LOCKSCREEN_OS10 = "TAG_SELECT_LOCKSCREEN_OS10";
    ...
    public static final String Check_WALLPAPER_GALLERY = "Check_WALLPAPER_GALLERY";
    ...
    public static WeatherTodayEntity getCurrentWeather(Context context) {
        ...
        try {
            obj = gson.fromJson(json, WeatherTodayEntity.class);
