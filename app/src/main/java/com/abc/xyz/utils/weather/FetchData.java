package com.abc.xyz.utils.weather;
...
public class FetchData {
    ...
    public String[] readData() throws JSONException {
        ...
        String iconNextDay = convertWeatherCode(forecast.getJSONObject(1).getString("code"));
        ...
        iconNextDay = convertWeatherCode(forecast.getJSONObject(2).getString("code"));
        ...
        iconNextDay = convertWeatherCode(forecast.getJSONObject(3).getString("code"));
        ...
        iconNextDay = convertWeatherCode(forecast.getJSONObject(4).getString("code"));
