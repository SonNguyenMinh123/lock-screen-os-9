...
/**
 * A Material style progress wheel, compatible up to 2.2. Todd Davies' Progress Wheel https://github.com/Todd-Davies/ProgressWheel
 *
...
public class ProgressWheel extends View {
    ...
    /**
     * @return the base spinning speed, in full circle turns per second (1.0 equals on full turn in one second), this value also is
     * applied for the smoothness when setting a progress
     */
    ...
    /**
     * Sets the base spinning speed, in full circle turns per second (1.0 equals on full turn in one second), this value also is
     * applied for the smoothness when setting a progress
     *
