package com.abc.xyz.views.widgets.shimmertextview;
 ...
 */
public class ShimmerTextView extends TextviewIPBold_ChangeColor implements ShimmerViewBase {
    ...
    public ShimmerTextView(Context context) {
     ...
     /*   if (!SharedPreferencesUtil.getpreferences(mContext, "Text_Color").equals("0")) {
            try {
                setTextColor(Integer.parseInt(SharedPreferencesUtil.getpreferences(mContext, "Text_Color")));
